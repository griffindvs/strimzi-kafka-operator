...
||||||| f3992184c (Do not set Kafka.KafkaStatus.ListenerStatus.type property (#9061))
  observedGeneration: 3 # <5>
=======
      type: external4
  observedGeneration: 3 # <5>
>>>>>>> parent of f3992184c (Do not set Kafka.KafkaStatus.ListenerStatus.type property (#9061))
----
